    ...
    updateuser(user) {
        return new Promise((resolve, reject) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (token == undefined)
                ...
                luser.updateUser(user).then((rows) => {
                    resolve(rows);
                })
                    .catch((err) => {
                    this.context.request.app.locals.LOGGER.error(JSON.stringify(err));
    ...
    updateuserfield(user) {
        return new Promise((resolve, reject) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (token == undefined)
                ...
                luser.updateUserField(user.email, user.field, user.value).then((rows) => {
                    resolve(rows);
                })
                    .catch((err) => {
                    this.context.request.app.locals.LOGGER.error(JSON.stringify(err));
...
tslib_1.__decorate([
    typescript_rest_1.GET,
    typescript_rest_1.Path("addbuddy/:buddy"),
    typescript_rest_1.Security(["ROLE_ADMIN", "ROLE_USER"]),
    tslib_1.__param(0, typescript_rest_1.PathParam("buddy")),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [String]),
    tslib_1.__metadata("design:returntype", Promise)
], ConvergenceService.prototype, "addBuddy", null);
tslib_1.__decorate([
    typescript_rest_1.GET,
    typescript_rest_1.Path("deletebuddy/:buddy"),
    typescript_rest_1.Security(["ROLE_ADMIN", "ROLE_USER"]),
    tslib_1.__param(0, typescript_rest_1.PathParam("buddy")),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [String]),
    tslib_1.__metadata("design:returntype", Promise)
], ConvergenceService.prototype, "deleteBuddy", null);
tslib_1.__decorate([
    typescript_rest_1.POST,
    typescript_rest_1.Path("login"),
...
tslib_1.__decorate([
    typescript_rest_1.POST,
    typescript_rest_1.Path("updateuserfield"),
    typescript_rest_1.Security(["ROLE_ADMIN", "ROLE_USER"]),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [Object]),
    tslib_1.__metadata("design:returntype", Promise)
], ConvergenceService.prototype, "updateuserfield", null);
tslib_1.__decorate([
    typescript_rest_1.GET,
