...
describe('UNIT-TEST CONVERGENCE SERVER ACTIVITY', () => {
    ...
    describe('UNIT-TEST CONVERGENCE SERVER CHAT', () => {
        ...
        it('userjwt.chatLeave should return defined', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            try {
                yield userjwt.connect({ user: "giulio.stumpo@gmail.com", password: "giulio2" });
                //await sleep(500)
                yield expect(userjwt.chatLeave("TEST_ROOM")).resolves.toBeDefined();
                //await sleep(500)
                yield userjwt.disconnect();
            }
            catch (error) { }
        ...
        it('userjwt.chatSend should return defined', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            try {
                yield userjwt.connect({ user: "giulio.stumpo@gmail.com", password: "giulio2" });
                //await sleep(500)
                yield expect(userjwt.chatSend("TEST_CHAN", "This is a message from Giulio")).resolves.toBeDefined();
                //await sleep(500)
                yield userjwt.disconnect();
            }
            catch (error) { }
        }));
        it('userjwt.chatJoin <other user> should return defined', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            try {
                yield userjwt.connect({ user: "carlotta.garlanda@livingnet.eu", password: "carlotta" });
                //await sleep(500)
                yield expect(userjwt.chatJoin("TEST_CHAN")).resolves.toBeDefined();
                //await sleep(500)
                yield userjwt.disconnect();
        ...
        it('userjwt.chatSend <other user> should return defined', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            try {
                yield userjwt.connect({ user: "carlotta.garlanda@livingnet.eu", password: "carlotta" });
                //await sleep(500)
                yield expect(userjwt.chatSend("TEST_CHAN", "This is a message from Carlotta")).resolves.toBeDefined();
                //await sleep(500)
                yield userjwt.disconnect();
            }
            catch (error) { }
        }));
        it('userjwt.chatChangeName should return defined', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            try {
                yield userjwt.connect({ user: "giulio.stumpo@gmail.com", password: "giulio2" });
                //await sleep(500)
                yield expect(userjwt.chatChangeName("TEST_CHAN", "NEW_NAME")).resolves.toBeDefined();
                //await sleep(500)
                yield userjwt.disconnect();
            }
            catch (error) { }
