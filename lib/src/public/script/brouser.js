    ...
    */
    ...
    subscribeActivityEvents(activity) {
        activity.on(Conv.ActivitySessionLeftEvent.EVENT_NAME, (ret) => {
            const res = {
                user: isomorphic_ws_1.default, evt: isomorphic_ws_1.default, sessionId: isomorphic_ws_1.default, participant: isomorphic_ws_1.default
            };
        ...
        activity.on(Conv.ActivityStateSetEvent.EVENT_NAME, (ret) => {
            const res = {
                user: isomorphic_ws_1.default, evt: isomorphic_ws_1.default, sessionId: isomorphic_ws_1.default, key: isomorphic_ws_1.default, value: isomorphic_ws_1.default
            };
            res.evt = "activity_session_join";
            res.user = ret.user;
            res.sessionId = ret.sessionId;
        ...
        activity.on(Conv.ActivityStateRemovedEvent.EVENT_NAME, (ret) => {
            const res = {
                user: isomorphic_ws_1.default, evt: isomorphic_ws_1.default, sessionId: isomorphic_ws_1.default, key: isomorphic_ws_1.default, oldvalue: isomorphic_ws_1.default
            };
            res.evt = "activity_session_join";
            res.user = ret.user;
            res.sessionId = ret.sessionId;
        ...
        activity.on(Conv.ActivityStateClearedEvent.EVENT_NAME, (ret) => {
            const res = {
                user: isomorphic_ws_1.default, evt: isomorphic_ws_1.default, sessionId: isomorphic_ws_1.default, key: isomorphic_ws_1.default, oldvalues: isomorphic_ws_1.default
            };
            res.evt = "activity_session_join";
            res.user = ret.user;
            res.sessionId = ret.sessionId;
...
Brouser.EVT_ACTIVITYSESSIONLEFT = Conv.ActivitySessionLeftEvent.EVENT_NAME;
Brouser.EVT_ACTIVITYSESSIONJOINED = Conv.ActivitySessionJoinedEvent.EVENT_NAME;
Brouser.EVT_ACTIVITYSTATESET = Conv.ActivityStateSetEvent.EVENT_NAME;
Brouser.EVT_ACTIVITYSTATEREMOVED = Conv.ActivityStateRemovedEvent.EVENT_NAME;
Brouser.EVT_ACTIVITYSTATECLEARED = Conv.ActivityStateClearedEvent.EVENT_NAME;
// ACTION TYPES
